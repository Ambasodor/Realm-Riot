...
public class OptWnd extends Window {
    ...
    public class BindingPanel extends Panel {
		...
		public BindingPanel(Panel back) {
			...
			y = addbtnImproved(cont, "Aggro Nearest Player To Cursor", "Selects the nearest non-aggroed/aggroed Player to attack by proximity radius.", new Color(255, 0, 0,255), GameUI.kb_aggroNearestProximityPlayerButton, y);
...
//			y = addbtn(cont, "Mute Non-Friendly", GameUI.kb_toggleMuteNonFriendly, y+26);
	...
	public static CheckBox autoFlowerUsesAllInventoriesCheckBox;
	...
	public static HSlider proximityradiusSLIDER;
	...
	public class NDCombatSettingsPanel extends Panel {
		public NDCombatSettingsPanel(Panel back) {
			...
			prev = add(proximityaggroPVPCheckBox = new CheckBox("Aggro players in proximity to the mouse cursor") {
				{a = Utils.getprefb("ProximityAggroPVP", false);}
				public void set(boolean val) {
					Utils.setprefb("ProximityAggroPVP", val);
					a = val;
				}
			}, prev.pos("bl").adds(0, 2));
			prev = add(proximityradiusSLIDER = new HSlider(UI.scale(200), 10, 480, Utils.getprefi("ProximityPvPSlider", 100)) {
				public void changed() {
					Utils.setprefi("ProximityPvPSlider", val);
				}
				@Override
	...
	private void setTooltipsForInterfaceSettingsStuff() {
		...
		disableMapTileTransition.tooltip = RichText.render("$col[185,185,185]{Disable map tile transition between different biomes and tiles (Need restart to work).}", UI.scale(300));
	...
	private void setTooltipsForGameplaySettingsStuff(){
		...
		autoFlowerUsesAllInventoriesCheckBox.tooltip = RichText.render("By default, the Auto Flower Repeater Script only runs through your main inventory. Enabling this option will allow it to run through all inventories, such as open containers, etc.", UI.scale(300));
