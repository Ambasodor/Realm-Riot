...
//	    iconwnd = null;
	...
	public static KeyBinding kb_aggroNearestProximityPlayerButton = KeyBinding.get("AggroNearestPlayerProximityButtonKB",  KeyMatch.nil);
	...
	public boolean globtype(char key, KeyEvent ev) {
		...
		else if(kb_aggroNearestProximityPlayerButton.key().match(ev)) {
			this.runActionThread(new Thread(new AggroProximityPlayer(this), "AggroNearestPlayerProximity"));
			return(true);
		}
